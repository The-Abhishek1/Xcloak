...
function Report() {
  ...
  <div className="max-w-6xl mx-auto rounded-2xl shadow-xl border border-gray-200 p-6">
    <h1 className="text-2xl sm:text-3xl font-extrabold text-center text-gradient bg-gradient-to-r from-purple-600 via-pink-500 to-red-500 text-transparent bg-clip-text mb-4">
      ⚡ ZAP Scan Report
    </h1>
    <p className="text-center text-gray-600 text-sm mb-6">
      Below is the detailed vulnerability assessment report generated via <strong>ZAP Proxy</strong>.
      Review it carefully to identify potential issues in your web application.
    </p>
